#
# Be sure to run `pod lib lint DZATimer.podspec' to ensure this is a
...
You can also init the timer with a delegate, and the timer will send an event after every timestep.
                       DESC
  s.homepage         = "https://github.com/Dzamir/DZATimer"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Davide Di Stefano" => "dzamirro@gmail.com" }
  s.source           = { :git => "https://github.com/Dzamir/DZATimer.git", :tag => s.version.to_s }
